...
namespace Dungeons
{
    internal class NPC
    {
        ...
        static public void QuestNPC(ref bool EnemyDead, ref bool TalkToNPC, ref bool TalkTalk, ref bool RewardNPC, ref int Money,
            ref bool SecondQuest, ref bool WizardMoney, ref bool WizardKill, ref bool NpcKilled, ref bool NpcReward, int PlayerHp, ref bool StrenghtUp)
        {
            {
        ...
        static public void Monster(ref bool TalkToNPC, ref bool EnemyDead, ref bool IsFight, int PlayerHp,
        ...
        static public void Doctor( int PlayerHp, ref int Money)
        {
            if (PlayerHp >= 100)
            {
